...
<head>
    ...
    <script>
          /* const mul = function(x, y){
           ...
           let data = [["윤혜원", "./images/photo1.jpg", 800],
                    ["윤혜투", "./images/photo2.jpg", 600],
                    ["윤혜쓰리", "./images/photo3.jpg", 700],
                    ["윤혜포", "./images/photo4.jpg", 500]]

           function tablePrint(){
            
            let text = '';
            text = `<table class="w3-table-all w3-hoverable"><tr class="w3-blue"><th>작가명</th><th>작품</th><th>가격</th></tr>`;
...
<body onload="tablePrint();">
    <header>
        ...
        <div class="w3-indigo">
            ...
            <span class="w3-xlarge">♥Hyewon Site♥</span>
        </div>
